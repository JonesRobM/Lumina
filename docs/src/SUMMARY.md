...
- [Coupled Dipole Approximation](./theory/cda.md)
- [Dyadic Green's Function](./theory/greens-function.md)
...
- [Configuration (TOML)](./user-guide/configuration.md)
- [Materials](./user-guide/materials.md)
- [Geometry & Shapes](./user-guide/geometry.md)
- [GUI Dashboard](./user-guide/gui.md)
- [CLI Usage](./user-guide/cli.md)

# Developer Guide

- [Architecture Overview](./developer/architecture.md)
- [Compute Backends](./developer/compute-backends.md)
- [Adding a New Solver](./developer/new-solver.md)
- [Contributing](./developer/contributing.md)

# Roadmap

- [Version Roadmap](./roadmap/versions.md)
- [Future Extensions](./roadmap/extensions.md)
